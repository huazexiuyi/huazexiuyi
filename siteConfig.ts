...
export const siteConfig = {
  // 1. 网站标题与博主信息
  title: "花泽秀一 の 宝藏之地",
  faviconUrl: "https://aass.de5.net//i/2026/07/17/6a598abb94b6e.jpg",
  authorName: "花泽秀一",
  bio: "一个在顺丰摸爬滚打的年轻人",
  ...
  avatarUrl: "https://aass.de5.net//i/2026/07/17/6a598abb94b6e.jpg",
...
// 修改这里：变成图片数组
  ...
  cloudMusicIds: ["1317285056", "2666260052", "27493175", "25638306"],
  social: {
    github: "https://github.com/huazexiuyi",
    gitee: "https://github.com/huazexiuyi",
    google: "huaxexiuyi@gmail.com",
    email: "3615822422@qq.com",
    qq: "3615822422",
    wechat: "-Yyf0824-",
  },
  counts: {
  ...
  gitalkConfig: {
    clientID: "Ov23li5QopNRPCC6vBWT",
    clientSecret: "fddee34a3aeaeaf0c425bb33b29975f4e0564cad",
    repo: "XHBlogS2",
    owner: "huazexiuyi",
    admin: [""],
  },
  buildDate: "2026-07-17T09:00:00", // 建站日期
  ...
  friendLinkApplyFormat: "名称：花泽秀一の宝藏之地\n简介：今天我也要学习吗\n链接：https://www.xiuyi.me\nhttps://aass.de5.net//i/2026/07/17/6a598abb94b6e.jpg",
